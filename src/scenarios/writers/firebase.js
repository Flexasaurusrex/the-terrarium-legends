...
// TODO: Create separate Firebase project for Writers Room
// For now, using same DB as Legends (will work when backend switches to writers mode)
...
const app = initializeApp(firebaseConfig, 'writers');
